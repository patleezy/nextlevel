            ...
            <div style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.1)", borderRadius: 20, padding: 20, marginBottom: 20 }}>
              ...
              <div style={{ position: "relative", marginBottom: 16 }}>
                ...
                <input
                  ...
                  style={{ width: "100%", boxSizing: "border-box", background: "rgba(255,255,255,0.06)", border: "1.5px solid rgba(255,255,255,0.12)", borderRadius: 10, padding: "8px 32px 8px 32px", color: "#f1f5f9", fontSize: 13, fontWeight: 600, fontFamily: "inherit", outline: "none" }}
                />
                {searchQuery && (
